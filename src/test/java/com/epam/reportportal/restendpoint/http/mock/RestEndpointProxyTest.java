...
public class RestEndpointProxyTest extends BaseRestEndointTest {
	...
	public void testGetWithQuery() throws IOException, InterruptedException {
		Map<String, String> queryParams = ImmutableMap.<String, String>builder().put("param1", "value1").put("param2", "value2").build();
		...
		assertSoft(request.getPath(), is("/?" + Joiner.on("&").withKeyValueSeparator("=").join(queryParams)), "Incorrect Request Path");
